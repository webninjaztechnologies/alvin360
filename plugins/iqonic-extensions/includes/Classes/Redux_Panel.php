...
if (!class_exists('Redux_Panel', true)) {
...
<?php
		...
		{
			$this->iqonic_settings_sections($this->parent->args['opt_name'] . $k . '_section_group');
		}
		
		public function iqonic_settings_sections($page)
		{
			...
			foreach ((array) $wp_settings_sections[$page] as $section) {
				...
				echo '<div class="table-wrap"><table class="form-table" role="presentation">';
