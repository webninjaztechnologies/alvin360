<div class="uap-wrapper">
	...
	<div class="uap-stuffbox">
		<h3 class="uap-h3"><?php esc_html_e('Admin Referral Notifications', 'uap');?><span class="uap-admin-need-help"><i class="fa-uap fa-help-uap"></i><a href="https://ultimateaffiliate.pro/docs/admin-referral-notifications/" target="_blank"><?php esc_html_e('Need Help?', 'uap');?></a></span></h3>
		<div class="inside">
			...
			<div class="row">
				<div class="col-xs-10">
					...
					<input type="checkbox" class="uap-switch" onClick="uapCheckAndH(this, '#uap_admin_referral_notifications_enable');" <?php echo esc_attr($checked);?> />
					<div class="switch uap-display-inline"></div>
					</label>
					<input type="hidden" name="uap_admin_referral_notifications_enable" value="<?php echo esc_attr($data['metas']['uap_admin_referral_notifications_enable']);?>" id="uap_admin_referral_notifications_enable" />
				</div>
			</div>
			...
			<div class="row">
				<div class="col-xs-6">
					...
					<input type="text" class="uap-field-text-with-padding form-control" name="uap_admin_referral_notification_subject" value="<?php echo esc_attr($data['metas']['uap_admin_referral_notification_subject']);?>"/>
				</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="uap-wp-editor-constants">
						...
						<?php endforeach; ?>
							<div ><?php echo esc_uap_content('<span><strong>' . esc_html__('WooCommerce Order Details', 'uap') . '</strong></span> : {WOOCOMMERCE_ORDER_DETAILS}');?></div>
						<?php
