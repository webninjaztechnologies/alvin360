	...
	class Redux_Spacing extends Redux_Field {
		...
		public function render() {
			...
			if ( true === $this->field['all'] ) {
				...
				echo '<div class="field-spacing-input input-prepend">
                        ...
                        <input
                            ...
                            placeholder="' . esc_html__( 'All', IQONIC_REACTION_TEXT_DOMAIN ) . '"
				...
				if ( true === $this->field['top'] ) {
					echo '<div class="field-spacing-input input-prepend">';
                        ...
                        echo '<input type="text"
                                   ...
                                   placeholder="' . esc_html__( 'Top', IQONIC_REACTION_TEXT_DOMAIN ) . '"
				...
				if ( true === $this->field['bottom'] ) {
					echo '<div class="field-spacing-input input-prepend">';
                            ...
                            echo '<input type="text"
                                   ...
                                   placeholder="' . esc_html__( 'Bottom', IQONIC_REACTION_TEXT_DOMAIN ) . '"
				...
				if ( true === $this->field['right'] ) {
					echo '<div class="field-spacing-input input-prepend">';
                            ...
                            echo '<input type="text"
                                   ...
                                   placeholder="' . esc_html__( 'Right', IQONIC_REACTION_TEXT_DOMAIN ) . '"
				...
				if ( true === $this->field['left'] ) {
					echo '<div class="field-spacing-input input-prepend">';
                            ...
                            echo '<input type="text"
                                   ...
                                   placeholder="' . esc_html__( 'Left', IQONIC_REACTION_TEXT_DOMAIN ) . '"
			...
			if ( false !== $this->field['units'] && true === $this->field['display_units'] ) {
				echo '<div class="select_wrapper spacing-units" original-title="' . esc_html__( 'Units', IQONIC_REACTION_TEXT_DOMAIN ) . '">';
				...
				echo '<select data-placeholder="' . esc_html__( 'Units', IQONIC_REACTION_TEXT_DOMAIN ) . '" class="redux-spacing redux-spacing-units select ' . esc_attr( $this->field['class'] ) . '" original-title="' . esc_html__( 'Units', IQONIC_REACTION_TEXT_DOMAIN ) . '" id="' . esc_attr( $this->field['id'] ) . '_units"' . esc_attr( $select2_data ) . '>';
