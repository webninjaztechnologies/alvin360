...
<div class="card-main imt-profile-box">
        ...
        <div class="item-header-cover-image-wrapper">
            <div id="item-header-cover-image">
                ...
                <div id="item-header-content" class="row align-items-center">
                    ...
                    <div class="imt-profile-center col-lg-4">
                        ...
                        <div class="imt-userinfo">

                            <div class="info-meta"><i class="iconly-Location icli"></i><span class="imt-profile-member-location"><?php echo esc_html("Location", IQONIC_MODERATION_TEXT_DOMAIN); ?></span></div>

                            <div class="info-meta"><i class="icon-web"></i><span class="imt-profile-member-website"><a href="#"><?php echo esc_html("Website", IQONIC_MODERATION_TEXT_DOMAIN); ?></a></span></div>

                        </div>

                        <div class="imt-profile-tab-button" id="members-dir-list">
                            <!--  Message Button -->
                    ...
                    <div class="imt-profile-right col-lg-4">
                        <ul class="imt-user-meta list-inline">
