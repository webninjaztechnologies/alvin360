		...
		public function render() {
			...
			if ( true === $this->field['width'] ) {
				...
				echo '<input
						...
						placeholder="' . esc_html__( 'Width', IQONIC_MODERATION_TEXT_DOMAIN ) . '"
			...
			if ( true === $this->field['height'] ) {
				...
				echo '<input
						...
						placeholder="' . esc_html__( 'Height', IQONIC_MODERATION_TEXT_DOMAIN ) . '"
			...
			if ( isset( $this->field['units'] ) && false !== $this->field['units'] ) {
				echo '<div
						...
						original-title="' . esc_html__( 'Units', IQONIC_MODERATION_TEXT_DOMAIN ) . '">';
				...
				echo '<select
						data-id="' . esc_attr( $this->field['id'] ) . '"
						data-placeholder="' . esc_html__( 'Units', IQONIC_MODERATION_TEXT_DOMAIN ) . '"
