...
switch ( $accessType ){
    case 'regular_period':
      $trialPrice = isset( $subscriptionMetas['access_trial_price']  ) ? $subscriptionMetas['access_trial_price']  : '';
      if ( $trialPrice === '' && isset( $membershipData['access_trial_price'] ) ){
          $trialPrice = $membershipData['access_trial_price'];
      }
      $trialType = isset( $subscriptionMetas['access_trial_type']  ) ? $subscriptionMetas['access_trial_type']  : '';
      if ( $trialType === '' && isset( $membershipData['access_trial_type'] ) ){
          $trialType = $membershipData['access_trial_type'];
      }
